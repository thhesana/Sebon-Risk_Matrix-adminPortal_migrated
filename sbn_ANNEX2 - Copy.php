    ...
    try {
        ...
        foreach($_POST as $key => $value) {
            if(strpos($key, 'sebon_remarks_') === 0) {
                ...
                // Validate SEBON remarks
                if(empty($sebonRemarks)) {
                    $validationErrors[] = "SEBON Remarks is required for Question ID: $questionId";
                }
                
                // Validate Risk Rating
                if(empty($riskRating)) {
                    $validationErrors[] = "Risk Rating is required for Question ID: $questionId";
                } elseif(!is_numeric($riskRating) || $riskRating < 1 || $riskRating > 5) {
                    $validationErrors[] = "Risk Rating must be between 1 and 5 for Question ID: $questionId";
                }
            }
        }
            ...
            <table class="questionnaire-table">
                <thead>
                    <tr>
                        ...
                        <th>Risk Rating (1-5) <span style="color: #e74c3c;">*</span></th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
                        ...
                        <tr>
                            ...
                            <td class="sebon-remarks-cell">
                                <textarea 
                                    ...
                                    placeholder="Enter SEBON remarks here... (Required)"
                                    required
                                ><?php echo htmlspecialchars($answer['sebon_remarks']); ?></textarea>
                            </td>
                            <td class="risk-rating-cell">
                                <input 
                                    ...
                                    max="5"
                                    step="1"
                                    value="<?php echo htmlspecialchars($answer['risk_rating']); ?>"
                                    required
                                >
                            </td>
                        </tr>
